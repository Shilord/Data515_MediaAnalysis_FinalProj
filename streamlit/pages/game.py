...
from core.state import init_state, submit_step, reset_game, go_home, start_normal_mode
...
def render():
    ...
    # Get valid movies for current actor
    valid_movies = get_movies_for_actor(current_actor, data)

    # Reset cache if movie changed
    ...
    if movie_input:
        ...
        if not matched_movie_id:
            ...
            if not cast_dict:
                ...
                if confirmed:
                    # Map back from name to actor_id
                    next_actor_id = None
                    ...
                    if not next_actor_id:
                        ...
                        submit_step(movie_input, next_actor_id)
